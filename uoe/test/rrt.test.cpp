...
auto main(int argc, char* argv[]) -> int {
    ...
    auto rrt = uoe::rrt::RRT::from_rosparam("/uoe/rrt");
    ...
    auto text_msg_gen = uoe::utils::rviz::text_msg_gen{text_size};
    ...
    const auto goal_tolerance = [&]() {
        ...
        if (! nh.getParam("/uoe/rrt/max_dist_goal_tolerance", goal_tolerance)) {
