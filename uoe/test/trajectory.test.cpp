...
auto main(int argc, char* argv[]) -> int {
    ...
    auto rate = ros::Rate(uoe::utils::DEFAULT_LOOP_RATE * 2);

    auto pub_visualisation =
        nh.advertise<visualization_msgs::Marker>("/uoe/visualisation/marker", uoe::utils::DEFAULT_QUEUE_SIZE);
    ...
    auto t = uoe::trajectory::CompoundTrajectory(nh, rate, path, marker_scale);
    ...
    m.header.frame_id = uoe::utils::FRAME_WORLD;
