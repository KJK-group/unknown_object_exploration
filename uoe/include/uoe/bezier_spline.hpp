...
// using uoe::utils::binomial_coefficient;
using std::abs;
using std::pair;
using std::pow;
using std::vector;
...
constexpr auto generate_binomial_lut() -> std::array<int, binomial_lut_size> {
    ...
    for (int r = 0; r < binomial_coefficient_amount; r++) {
        for (int c = 0; c < r; c++) {
            lut[r * (binomial_coefficient_amount) + c] = (uoe::utils::binomial_coefficient(r, c));
        }
    }
    return lut;
}
// static constexpr std::array<float, binomial_lut_size> binomial_lut{
//     uoe::utils::binomial_coefficient(binomial_lut_size, 0),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 1),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 2),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 3),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 4),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 5),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 6),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 7),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 8),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 9),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 10),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 11),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 12),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 13),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 14),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 15),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 16),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 17),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 18),
//     uoe::utils::binomial_coefficient(binomial_lut_size, 19)};
