...
auto mission_cb(const uoe_msgs::MissionStateStamped::ConstPtr& state) -> void {
    mission_state = *state;
}
...
auto main(int argc, char* argv[]) -> int {
    ...
    auto mission_sub = nh.subscribe<uoe_msgs::MissionStateStamped>(
        "/uoe/mission/state", uoe::utils::DEFAULT_QUEUE_SIZE, mission_cb);
