...
auto main(int argc, char** argv) -> int {
    ...
    ros::Rate rate(uoe::utils::DEFAULT_LOOP_RATE * 6);

    uoe::control::PID gains_xy{};
    uoe::control::PID gains_yaw{};
    uoe::control::PID gains_z{};
    ...
    // pid controller
    auto controller = uoe::control::PIDController(nh, rate, gains_xy, gains_z, gains_yaw, true);
    controller.run();
