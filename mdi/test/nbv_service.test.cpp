...
#include "mdi_msgs/NBVRequest.h"
#include "mdi_msgs/NBVResponse.h"
...
auto main(int argc, char* argv[]) -> int {
    ...
    auto client_nbv = [&] {
        const auto service_name = "/mdi/rrt_service/nbv"s;
        return nh.serviceClient<mdi_msgs::NBV>(service_name);
    }();
    ...
    auto request = mdi_msgs::NBVRequest{};
